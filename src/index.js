...
module.exports = function(schema, option) {
  ...
  const transformUnit = unit => {
    return (parseInt(unit) * _w).toFixed(2);
  };
  ...
  const parseStyle = style => {
    ...
    for (let key in style) {
      ...
      switch (key) {
        case 'fontSize':
          mapStyle['fontSize'] = `Adapt.px(${val})`;
          break;
        case 'color':
        ...
        case 'backgroundColor':
          ...
          break;
        case 'borderRadius':
          mapStyle['borderRadius'] = `BorderRadius.circular(Adapt.px(${val}))`;
          break;
        case 'marginLeft':
          flutterMargin[0] = `Adapt.px(${val})`;
          break;
        case 'marginTop':
          flutterMargin[1] = `Adapt.px(${val})`;
          break;
        case 'marginRight':
          flutterMargin[2] = `Adapt.px(${val})`;
          break;
        case 'marginBottom':
          flutterMargin[3] = `Adapt.px(${val})`;
          break;
        case 'paddingLeft':
          flutterPadding[0] = `Adapt.px(${val})`;
          break;
        case 'paddingTop':
          flutterPadding[1] = `Adapt.px(${val})`;
          break;
        case 'paddingRight':
          flutterPadding[2] = `Adapt.px(${val})`;
          break;
        case 'paddingBottom':
          flutterPadding[3] = `Adapt.px(${val})`;
          break;
        case 'height':
        case 'width':
        case 'maxWidth':
